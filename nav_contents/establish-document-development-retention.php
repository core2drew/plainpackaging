        ...
        <div class="content-desc-cont">
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <div class="inner-box-style">
                    ...
                    <ol class="custom">
                        ...
                        <li>Communications or meetings with external public health bodies, experts, or civil
                            society organizations with documentation of attendees;
                        </li>
                        ...
                        <li>Any external written submissions received from organizations or industry, whether
                            as part of the a consultation or otherwise;and
                        </li>
                        <li>Both internal and external correspondence including emails relating to the
                            policy.
                        </li>
                    </ol>
                    <p class="table-note">*Meetings with the tobacco industry or industry representatives
                        ...
                        from commercial and other vested interests. <sup>1</sup></p>
                </div>
                ...
                <p><span class="fc-violet"><b>IN THE INTERNATIONAL INVESTMENT ARBITRATION</b></span> claim
                    brought by Philip Morris International against two of Uruguay’s tobacco control laws,<sup>2</sup>
                    ...
                    that Uruguay’s Single Presentation Requirement (which only permits each brand to have a
                    ...
                    Switzerland:</p>
                <p class="p-states-black">“In my view, <b>the record does not support</b> a conclusion that
                    ...
                    authorities . . .</p>
                <p class="p-states-black">It is significant that the evidentiary record contains no minutes,
                ...
                <p>The position of the Uruguayan Government was that the policy was properly considered
                    ...
                    the three arbitrators was prepared to find a breach of the Bilateral Investment Treaty that could
                    have led to huge damages being awarded is a reminder to governments of the need to
                    follow due process and keep a record of that process.</p>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
            ...
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <p><sup>1</sup>The InternationalUnion Against Tuberculosis and Lung Disease has produced a Toolkit
                    with guides on how to implement the
                    FCTC Article5.3 and prevent tobacco industry interference:
                    <a href="http://www.theunion.org/what-we-do/publications/english/pubtc_Guides-set.pdf">www.theunion.org/what-we-do/publications/english/pubtc_Guides-set.pdf</a>.
                </p>
                <p><sup>2</sup> . Philip Morris Brand Sàrl (Switzerland), Philip Morris Products S.A. (Switzerland) and
                    Abal Hermanos S.A. (Uruguay) <i>v.</i> Oriental Republic of Uruguay (ICSID Case No. ARB/10/7). The award
                    and dissenting opinion are available from: <a
                            href="http://www.italaw.com/cases/460">www.italaw.com/cases/460</a>.
                </p>
            </div>
        </div>
    </div>
