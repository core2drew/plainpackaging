    ...
    <section id="about-state" class="container content-st-section">
        <div class="row abt-st-r">
            <div class="col-lg-8 col-lg-offset-1">
                ...
                <div>
                    <div class="section-margin-top-25 section-title fc-blue-home">Each clause explained</div>
                </div>
            </div>
            <div class="col-lg-3">
            <div class="sidebar-wrapper header-sidebar col-xs-12 sidebar-1">
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <a
                           href="<?php echo $base_url; ?>templates/template-draft-model-law"><img
                                    src="<?php echo $base_url; ?>img/icons/linked-tools-and-resources/document.PNG"
                                    style="padding:0 10px;">Template model law</a>
                    </li>
                    <li>
                        <a class="flex"
                           href="<?php echo $base_url; ?>resources/comparison-table-of-existing-plain-packaging-laws"><img
                                    src="<?php echo $base_url; ?>img/icons/linked-tools-and-resources
                                /legal-issues.PNG"
                                    style="padding:0 10px;">Comparison table of existing laws</a>
                    </li>
                </ul>
            </div>
        </div>
            <div class="content-desc-cont col-lg-8 col-lg-offset-1">
                <div>
                    <div class="section-secondary-title fc-blue-home">Introduction</div>
                ...
                <div >
                    <div class="section-secondary-title fc-blue-home">Existing Legislation</div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-3"><img class="img-responsive text-center"
                ...
                <div >
                    ...
                    <div class="section-secondary-title fc-blue-home">1. Color</div>
                ...
                <div >
                    ...
                    <div class="section-secondary-title fc-blue-home">2. Permitted Text</div>
                ...
                <div >
                    ...
                    <div class="section-secondary-title fc-blue-home">3. Requirements for text</div>
                ...
                <div >
                    ...
                    <div class="section-secondary-title fc-blue-home">4. Defining surfaces</div>
                ...
                <div >
                    ...
                    <div class="section-secondary-title fc-blue-home">5. Shape and type of packets</div>
                    ...
                    <div class="section-tertiary-title fc-blue-home"><u>Cigarettes:</u></div>
                    ...
                    <p>Shoulder box packs and soft packs are permitted for cigarettes in EU countries but not in
                        Australia.</p>
                    <div class="section-tertiary-title fc-blue-home"><u>Other tobacco products:</u></div>
                ...
                <div >
                    ...
                    <div class="section-secondary-title fc-blue-home">6. Type of opening</div>
                ...
                <div >
                    ...
                    <div class="section-secondary-title fc-blue-home">7. Minimum size of pack or minimum size of
                        health warning
                    </div>
                ...
                <div >
                    ...
                    <div class="section-secondary-title fc-blue-home">8. Material</div>
                ...
                <div >
                    ...
                    <div class="section-secondary-title fc-blue-home">9. Linings in cigarette packs</div>
                    ...
                    <div class="col-lg-12">
                        <div class="col-lg-4">
                            <img style="height:200px;" class="img-responsive text-center"
                                 src="<?php echo $base_url; ?>img/reference-materials/20170528_175225_resized.jpg">
                        </div>
                        <div class="col-lg-4">
                            <img
                                style="height:200px;" class="img-responsive text-center"
                                src="<?php echo $base_url; ?>img/reference-materials/20170528_175229_resized.jpg">
                        </div>
                        <div class="col-lg-4">
                            <img style="height:200px;" class="img-responsive text-center"
                                 src="<?php echo $base_url; ?>img/reference-materials/20170528_175223_resized.jpg">
                        </div>
                    </div>
                    <p>&nbsp;</p>
                    <p>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item10"></div>
                    <div class="section-secondary-title fc-blue-home">10. Texture</div>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item11"></div>
                    <div class="section-secondary-title fc-blue-home">11. Wrappers</div>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item12"></div>
                    <div class="section-secondary-title fc-blue-home">12. Tabs for resealing pouches</div>
                    ...
                    <div class="col-lg-12">
                        <div class="col-lg-6">
                            <img style="height:250px;" class="img-responsive text-center"
                                 src="<?php echo $base_url; ?>img/reference-materials/Manitou_Additive_Free_Hand_Rolling_Tobacco_30g_2D_0001.jpg">
                        </div>
                        <div class="spacer-mobile"><p>&nbsp;</p></div>
                        <div class="col-lg-6">
                            <img
                                style="height:250px;" class="img-responsive text-center"
                                src="<?php echo $base_url; ?>img/reference-materials/marlboro-gold-12gr--tobacco-hand-rolling-for-cigarette-enkedro-b1.jpg">
                        </div>
                    </div>
                    <p>&nbsp;</p>
                </div>
                <div >
                    <div class="sidebar-anchor-item" id="item13"></div>
                    <div class="section-secondary-title fc-blue-home">13. Sound and smell in the packaging</div>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item14"></div>
                    <div class="section-secondary-title fc-blue-home">14. Pack must not change after sale</div>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item15"></div>
                    <div class="section-secondary-title fc-blue-home">15. Inserts, onserts and other additional
                        material
                    </div>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item16"></div>
                    <div class="section-secondary-title fc-blue-home">16. Prohibit features that would suggest an
                        economic advantage
                    </div>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item17"></div>
                    <div class="section-secondary-title fc-blue-home">17. Bar codes (and QR codes etc)</div>
                ...
                <div >
                    <div class="section-secondary-title fc-blue-home">18. Allow for calibration marks</div>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item18"></div>
                    <div class="section-secondary-title fc-blue-home">19. Allow for track and trace or unique
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item19"></div>
                    <div class="section-secondary-title fc-blue-home">20. The appearance of individual products
                    </div>
                    ...
                    <div class="col-lg-12 text-center"><img style="height:600px;" class="img-responsive text-center" src="<?php echo $base_url; ?>img/reference-materials/cigarette.png">
                    </div>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item20"></div>
                    <div class="section-secondary-title fc-blue-home">21. Transitional arrangements</div>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item21"></div>
                    <div class="section-secondary-title fc-blue-home">22. Trade mark saving provision</div>
                ...
                <div >
                    <div class="sidebar-anchor-item" id="item22"></div>
                    <div class="section-secondary-title fc-blue-home">23. Country specific drafting issues</div>
            ...
            <div class="col-lg-3">
                <div class="sidebar-wrapper col-xs-12 sidebar-2">
                    <div class="sidebar-nav-header">EXISTING LEGISLATION</div>
                    <ul class="sidebar-nav">
                        <li>
                            <a class="flex" href="<?php echo $base_url; ?>#">
                            <img
                                    src="<?php echo $base_url; ?>img/icons/on-legal-issues.PNG" height="35"
                                    style="padding:0 10px;">Web links to plain packaging of tobacco legislation from around the world.</a>
                        </li>
                        <li>
                            <a href="#item1">Color</a>
                        </li>
                        <li>
                            <a href="#item2">Permitted text</a>
                        </li>
                        <li>
                            <a href="#item3">Requirements for text</a>
                        </li>
                        <li>
                            <a href="#item4">Defining Surfaces</a>
                        </li>
                        <li>
                            <a href="#item5">Shape and type of packets</a>
                        </li>
                        <li>
                            <a href="#item6">Pack openings</a>
                        </li>
                        <li>
                            <a href="#item7">Size of packs</a>
                        </li>
                        <li>
                            <a href="#item8">Materials</a>
                        </li>
                        <li>
                            <a href="#item9">Linings in cigarette packs</a>
                        </li>
                        <li>
                            <a href="#item10">Surface Texture</a>
                        </li>
                        <li>
                            <a href="#item11">Plastic wrappers</a>
                        </li>
                        <li>
                            <a href="#item12">Tabs for resealing pouches</a>
                        </li>
                        <li>
                            <a href="#item13">Sound and smell</a>
                        </li>
                        <li>
                            <a href="#item14">Pack must not change after resale</a>
                        </li>
                        <li>
                            <a href="#item15">Inserts, inserts and additional materials </a>
                        </li>
                        <li>
                            <a href="#item16">Features that suggest  economic advantage</a>
                        </li>
                        <li>
                            <a href="#item17">Bar codes and calibration marks</a>
                        </li>
                        <li>
                            <a href="#item18">Track and trace features</a>
                        </li>
                        <li>
                            <a href="#item19">Appearance of individual cigarette sticks</a>
                        </li>
                        <li>
                            <a href="#item20">Sell through period</a>
                        </li>
                        <li>
                            <a href="#item21">Trade mark saving provision</a>
                        </li>
                        <li>
                            <a href="#item22">Country specific drafting issues</a>
                        </li>
                    </ul>
                </div>
            </div>
