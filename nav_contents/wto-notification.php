...
<section id="about-state" class="container content-st-section">
    <div class="row abt-st-r">
        ...
        <div class="content-desc-cont col-lg-10 col-lg-offset-1">
            <div class="section-secondary-title fc-yellow-gold">1. World Trade Organization Article 2.9 of
        ...
        <div class="content-desc-cont col-lg-10 col-lg-offset-1">
            ...
            <p>This means that it should be at a stage that sets out the detail of what the government
                intends to adopt but is still capable of amendment. The WTO TBT procedure then requires
                <b>a sixty-day stand still period</b> during which amendments could still be made to the law,
                so that written comments from other WTO members
                can be sent on the draft measure.</p>
            <p>There is also a further requirement under Article 2.12 that the final adopted measure be published and
                it is recommended that there is a six month period between publication the date the new regulations
                come into
                force. This is to allow exporters from other WTO member countries sufficient time to change their
                manufacturing processes to comply with the new regulations. </p>

            <p>The sixty-day standstill period for the draft regulations and the six-month period between publication
                and coming into force should be factored into the legislative timetable if possible. </p>
        ...
        <div class="content-desc-cont col-lg-10 col-lg-offset-1">
            ...
            <p>To date, each country to have adopted plain packaging has notified their legislation under
                TBT 2.9. Examples of existing notifications can assist any government seeking to comply with
                the notification procedures.</p>
            <div class="col-lg-12 margin-btm-30">
                <div class="col-lg-6">
                    <ul class="custom">
                        <li>Ireland’s WTO TBT notification of June 17, 2014, is available from:<br><a
                        ...
                        <li>The UK’s WTO TBT notification of September 2014 is available from:<br><a
                ...
                <div class="col-lg-6">
                    <ul class="custom">
                        <li>Norway's WTO TBT notification of May 18, 2015, is available from:<br><a
                        ...
                        <li>Hungary’s WTO TBT notification of December 12, 2015, is available from:<br><a
            ...
            <p>Many of these notifications received comments from other member countries in T B T committee
                ...
                Australia (such as Indonesia, Dominican Republic, Cuba, and Honduras) and some tobacco-producing
                countries (such as Malawi, Zimbabwe, and Nicaragua), have given negative comments
                to the committees; However, many countries, including New Zealand, Norway, Canada, Uruguay, and the
                ...
                representative of the World Health Organization provided support for the measure and
        ...
        <div class="content-desc-cont col-lg-10 col-lg-offset-1">
            ...
            <p>At the time of writing, a WTO dispute settlement panel is adjudicating complaints by Cuba,
                ...
                providing funding and legal support for Honduras and the Dominican Republic in the
                proceedings.</p>
            <p>The panel’s decision is expected to be made public in July 2017.</p>
            <p>There are well-established principles and rules that demonstrate the flexibility for WTO
                ...
                packaging of tobacco products <sup>2</sup> and are set out briefly in in <a
                        href="<?php echo $base_url; ?>legal-issues-and-international-developments/legal-issues">LEGAL
                    ISSUES page of the Tools and Resources</a>. The main issues of dispute fall under Article 2.2 of
                the TBT Agreement and
                Article 20 of the Trade Related Aspects of Intellectual Property Agreement <span
                        class="font10">(TRIPS)</span>.</p>
