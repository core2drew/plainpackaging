    ...
    <div class="row abs-st-r">
        ...
        <div class="content-desc-cont col-lg-10 col-lg-offset-1">
            <p>
                ...
                piece of legislation. The laws for some countries impose extremely detailed requirements, and it is
        ...
        <div class="content-desc-cont col-lg-10 col-lg-offset-1">
            <table class="table table-bordered ref-e">
                ...
                <tr>
                    ...
                    <td>
                        <p>Pantone Cool Gray 2C, matte finish. <span
                                    class="h4-color">SPTPR sch1 ¶1(2) and Sch3 ¶1(2)</span>
                        </p>
                    </td>
                    <td>
