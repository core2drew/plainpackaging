<?php include_once('library/base_url.php'); ?>

<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
    <div class="container navbar-desktop">
        <div class="navbar-header">
            <div class="col-lg-12">
                <div class="col-lg-6 padding-0-1200">
                    <div class="col-lg-3 col-md-3 col-xs-3">
                        <a class="navbar-brand navbar-brand-a page-scroll" href="<?php echo $base_url; ?>"><img src="<?php echo $base_url; ?>img/banner/tfklogo.png"></a>
                    </div>
                    <div class="col-lg-9 col-md-9 col-xs-9">
                        <a class="navbar-brand page-scroll menu-title" href="<?php echo $base_url; ?>">
                            <span class="menu-title">Plain Packaging of<br> Tobacco Products Toolkit</span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="nav-cont navbar-right">
    ...
    <div class="container navbar-mobile">
        <div class="navbar-header">
            ...
            <div class="col-lg-9 col-md-9 col-xs-9">
                <a class="navbar-brand page-scroll menu-title" href="<?php echo $base_url; ?>">
                    <span class="menu-title">Plain Packaging of Tobacco Products Toolkit</span>
                </a>
            </div>
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <!-- step-by-step guides -->
                <li class="nav-static-menu">Short Step-By-Step Guides</li>
                <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Getting Prepared <b class="caret"></b></a>
                ...
                <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Collecting the Evidence <b class="caret"></b></a>
                    <ul class="dropdown-menu multi-level">
                        <li>
                            <a href="<?php echo $base_url ?>collecting-the-evidence/evidence-review">
                                <div class="dropdown-note">Guide 2.1</div>
                ...
                <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Crafting the Legislation <b class="caret"></b></a>
                    <ul class="dropdown-menu multi-level">
                        <li>
                            <a href="<?php echo $base_url ?>crafting-the-legislation/make-key-policy-decisions">
                                <div class="dropdown-note">Guide 3.1</div>
                ...
                <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Steps for a Secure Policy <b class="caret"></b></a>
                    <ul class="dropdown-menu multi-level">
                        <li>
                            <a href="<?php echo $base_url ?>procedural-steps-for-a-secure-policy/coordinate-across-government">
                                <div class="dropdown-note">Guide 4.1</div>
                ...
                <!-- reference materials -->
                <li class="nav-static-menu">Reference Materials</li>
                <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Resources <b class="caret"></b></a>
                    <ul class="dropdown-menu multi-level">
                        <li class="nav-static-sub-menu">Policy</li>
                        <li>
                            <a href="<?php echo $base_url; ?>resources/policy-briefs">Policy Briefs</a>
                        </li>
                        <li>
                            <a href="<?php echo $base_url; ?>resources/opposing-arguments-and-how-to-counter-them">Opposing Arguments</a>
                        </li>
                        <li>
                            <a href="<?php echo $base_url; ?>resources/international-developments">International Developments</a>
                        </li>
                    </ul>
                    <ul class="dropdown-menu multi-level">
                        <li class="nav-static-sub-menu">Legal</li>
                        <li>
                            <a href="<?php echo $base_url; ?>resources/comparison-table-of-existing-plain-packaging-laws">Comparison of Existing Laws</a>
                        </li>
                        <li>
                            <a href="<?php echo $base_url; ?>resources/drafting-the-legislation-in-detail">Each Clause Explained</a>
                        </li>
                        <li>
                            <a href="<?php echo $base_url; ?>resources/legal-issues">Legal Issues</a>
                        </li>
                        <li>
                            <a href="<?php echo $base_url; ?>resources/case-summaries">Case Summaries</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="dropdown-menu multi-level">
                        <li class="nav-static-sub-menu">Policy</li>
                        <li>
                            <a href="<?php echo $base_url; ?>templates/regulatory-impact-analysis-ref">Template Regulatory Impact Analysis</a>
                        </li>
                        <li>
                            <a href="<?php echo $base_url; ?>templates/consultation-document-template">Template Consultation Document</a>
                        </li>
                    </ul>
                    <ul class="dropdown-menu multi-level">
                        <li class="nav-static-sub-menu">Legal</li>
                        <li>
                            <a href="<?php echo $base_url; ?>templates/template-draft-model-law">Template Model Law</a>
                        </li>
                    </ul>
                </li>
                <li>
